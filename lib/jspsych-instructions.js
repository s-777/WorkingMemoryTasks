  ...
  plugin.info = {
    ...
    parameters: {
      ...
      page_number_label: {
        ...
        pretty_name: 'Page number label',
        default: 'P&aacute;gina',
        description: 'The text that that introduces the page number.'
      },
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      ...
      if(trial.show_page_number) {
          pagenum_display = trial.page_number_label+" "+(current_page+1)+"/"+trial.pages.length;
      }
